...
export default function BecomeVolunteerHero() {
  return (
    <SectionLayout className="pb-0! relative overflow-hidden pt-0!">
      <div className="relative md:aspect-16/10 min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh]">
        <div
        ...
        <div className="absolute inset-0 flex items-center justify-center md:justify-start">
          <ContainerLayout>
            <div className="flex flex-col w-full">
              <div className="bg-primary py-2 px-3 lg:py-4 lg:px-5 w-max mb-8">
              ...
              <p className="font-avenir text-white font-black text-sm sm:text-2xl md:text-[42px] lg:text-[66px] leading-[1.1em] -tracking-tighter mb-8 lg:mb-14">

...
export default function Hero() {
  return (
    <div className="w-full relative min-h-screen overflow-hidden background-slideshow pt-[90px] md:pt-[110px]">
      ...
      <div className="relative z-3 flex flex-col justify-center min-h-[calc(100vh-90px)] md:min-h-[calc(100vh-110px)]">
        <div className="w-full max-w-7xl px-4 sm:px-6 md:px-8 lg:px-20 py-8">
          <div className="max-w-full md:max-w-[500px] lg:max-w-[1000px]">
            <p className="text-white uppercase text-lg font-avenir font-extrabold tracking-[.15em] mb-5">
          ...
          <div className="btn mt-8 w-full xs:w-auto">
            <Button className="bg-primary w-full absolute bottom-0 left-0 sm:relative xs:w-auto hover:bg-light-yellow! hover:text-black text-white font-avenir! font-bold text-base leading-5 px-10 py-[25px]! rounded-none border-0">
              Apply for support
            </Button>
          </div>
        </div>

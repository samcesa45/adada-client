      ...
      <FieldWrapper label={label} error={error}>
        <div className="relative flex items-center">
          ...
          <input
            ...
            // )}
            className={cn(
              'flex h-12 text-sm sm:text-[1rem] border border-extra-light-grey sm:leading-7 w-full  font-avenir font-medium py-4 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-b disabled:cursor-not-allowed disabled:opacity-50 text-grey placeholder:text-lg',
              className,
            )}
            ref={ref}
            {...registration}
